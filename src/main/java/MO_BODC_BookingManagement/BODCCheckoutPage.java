...
//			int adt = Integer.parseInt(AdultM);
//		}
//		int adt = Integer.parseInt(adult);
//	}else {
//		int adt = Integer.parseInt("1");
//	}
		int adt = Integer.parseInt(adult);
		for (int i = 1; i <= adt; i++) {
			...
			if (date.isBefore(today.minusYears(12))) {
				...
				throw new BODCExceptionClass("Invalid Adult Date Selection" + " : " + Date + "-" + Month + "-" + Year);
			}
	...
	public static void GuestYouthCheckoutForFlight(String Youth, String YouthTitle, String YouthName, String YouthtDate,
			String YouthEmailAddress, String YouthPhoneNumber, String YouthPassportNumber, String YouthPassportcountry,
			String YouthtExpiryDate, String YouthNationality) throws Exception {
		int adt = Integer.parseInt(Youth);
		for (int i = 1; i <= adt; i++) {
			String adultTitleElement = "//select[@id='ddlTitleYth" + i + "']";
			String[] adulttitle = YouthTitle.split(",");
			QaRobot.selectTextByLocator1(adultTitleElement, adulttitle[i - 1], "<b><i>Select title for Youth</i></b>");
			Thread.sleep(2000);

			String NameSelection[] = YouthName.split(",");
			String NameS[] = NameSelection[i - 1].split(" ");
			String Fname = NameS[0];
			String Lname = NameS[1];

			String adultNameElement = "//input[@id='txt_firstNameYth" + i + "']";
			QaRobot.PassValueByLocator(adultNameElement, Fname, "<b><i>Entered Name For youth</i></b>");
			Thread.sleep(2000);

			String adultLNameElement = "//input[@id='txt_lastnameYth" + i + "']";
			QaRobot.PassValueByLocator(adultLNameElement, Lname, "<b><i>Entered Last Name For youth</i></b>");
			Thread.sleep(2000);

			QaBrowser.driver.findElement(By.xpath("//input[@id='txt_dobYth" + i + "']")).click();
			Thread.sleep(5000);
			String DateSelection[] = YouthtDate.split(",");
			String DateS[] = DateSelection[i - 1].split("-");
			String Date = DateS[0];
			String Month = DateS[1];
			String Year = DateS[2];
			...
			if (date.isBefore(today.minusYears(12))) {
				...
				QaExtentReport.test.log(Status.FAIL,
						"<b><i>Invalid Youth Date Selection</i></b>" + " - " + Date + "-" + Month + "-" + Year);
				throw new BODCExceptionClass("Invalid Youth Date Selection" + " : " + Date + "-" + Month + "-" + Year);
			}

			String adultphonenumberElement = "//input[@id='txt_mobileYth" + i + "']";
			String[] adultphone = YouthPhoneNumber.split(",");
			QaRobot.PassValueByLocator(adultphonenumberElement, adultphone[i - 1],
					"<b><i>Entered Phone Number For youth</i></b>");
			Thread.sleep(2000);

			String adultpassportElement = "//input[@id='txt_passportYth" + i + "']";
			String[] adultpass = YouthPassportNumber.split(",");
			QaRobot.PassValueByLocator(adultpassportElement, adultpass[i - 1],
					"<b><i>Entered Passport Number For youth</i></b>");
			Thread.sleep(2000);

			String adultpasscountryElement = "//select[@id='ddl_passCountryYth" + i + "']";
			String[] adultpc = YouthPassportcountry.split(",");
			QaRobot.selectTextByLocator1(adultpasscountryElement, adultpc[i - 1],
					"<b><i>Select Passport Country For youth</i></b>");
			Thread.sleep(2000);

			QaBrowser.driver.findElement(By.xpath("//input[@id='txt_ex_dateYth" + i + "']")).click();
			Thread.sleep(5000);
			String DateSelection1[] = YouthtExpiryDate.split(",");
			String DateS1[] = DateSelection1[i - 1].split("-");
			String Date1 = DateS1[0];
			String Month1 = DateS1[1];
			String Year1 = DateS1[2];
			...
			String text3 = "/html/body/div[3]/div/div[2]/div/div/select[2]";
			QaRobot.selectTextByLocator1(text3, Year1, "<b><i>Select Passport year for youth</i></b>");
			Thread.sleep(2000);
			String text2 = "/html/body/div[3]/div/div[2]/div/div/select[1]";
			QaRobot.selectTextByLocator1(text2, Month1, "<b><i>Select Passport month for youth</i></b>");
			Thread.sleep(2000);
			...
			String adultnationalityElement = "//select[@id='ddl_nationalityYth" + i + "']";
			String[] adultnat = YouthNationality.split(",");
			QaRobot.selectTextByLocator1(adultnationalityElement, adultnat[i - 1],
					"<b><i>Select Nationality For youth</i></b>");
			Thread.sleep(2000);

			String adultEmailElement = "(//input[@id='txt_emailLeadPax'])[2]";
			QaRobot.PassValueByLocator(adultEmailElement, YouthEmailAddress, "<b><i>Pass Email</i></b>");
			Thread.sleep(2000);
			QaRobot.ScreenshotMethod("AdultDetails", "<b><i>Screenshot for Youth Details</i></b>");
			QaExtentReport.extentScreenshot("Youth Details");
		}
	}
	...
	public static void GuestInfantCheckoutForFlight(String infant, String InfantTitle, String InfantName,
		...
		for (int i = 1; i <= ift; i++) {
			...
			if (date.isAfter(today.minusYears(2))) {
				...
				throw new BODCExceptionClass("Invalid Infant Date Selection" + " : " + Date + "-" + Month + "-" + Year);
			}
