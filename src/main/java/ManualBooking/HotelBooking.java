...
public class HotelBooking {
	...
	public static void corporateProfiling(String TestCaseId, String TestScenario, String Source, String URL,
		...
		FlightBooking.AddAdult(Adult, AdultName);
		FlightBooking.AddChild(Adult, Child, ChildName, ChildDOB);
		FlightBooking.AddInfant(Adult, Child, Infant, InfantName, InfantDOB);
...
//		QaRobot.PassValue("MBDCAddTravellerPhone", "9865326598");
		...
		String Year = DateS[2];
		FlightBooking.selectDate(Date, Month, Year);
		...
		FlightBooking.selectDate(Date1, Month1, Year1);
