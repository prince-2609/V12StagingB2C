...
public class B2cTripType {
	...
	public static void flightTriptype(String TripType, String Trip, String OriginCityCode, String OriginLocation,
		...
		if (TripType.equalsIgnoreCase("OneWay")) {
			QaRobot.ClickOnElement("OneWayB2C");
			...
			QaRobot.ClickOnElement("TravellersB2C");
			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Travellers</i></b>");

			QaRobot.selectValueFromDropdown("v12Adult", adult,
					"<b><i>Select adult for booking</i></b>" + " - " + adult);
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("v12Child", child,
					"<b><i>Select child for booking</i></b>" + " - " + child);
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("v12Infant", infant,
			...
			QaRobot.ClickOnElement("RoundTripB2C");
			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on submit</i></b>");
			...
			QaRobot.selectValueFromDropdown("v12Adult", adult,
					"<b><i>Select Number of adult for booking</i></b>" + " - " + adult);
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("v12Child", child,
					"<b><i>Select Number of child for booking</i></b>" + " - " + child);
			Thread.sleep(2000);

			QaRobot.selectValueFromDropdown("v12Infant", infant,
					"<b><i>Select Number of infant for booking</i></b>" + " - " + infant);
			Thread.sleep(2000);
		...
		try {
			...
			QaRobot.ClickOnElement("FinalSearchFF");
