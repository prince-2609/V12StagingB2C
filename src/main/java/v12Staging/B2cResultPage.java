...
{
	public static void ResultPageForFlight(String TripType,String ModifySearch,String ChangeTrip,String TripTypeM,String MarketTypeM,
			String OriginCityCodeM,String OriginLocationM,String DestinationCityCodeM,String DestinationLocationM,String ChangeTripDate,
			...
			String ClassM,String ShowDirectFlightM,String AdvanceOptions,String CurrencyM,String PANumberM,String PreferredAirlineSelectM,
			String Applyfilter,String FareType,String AirLine,String Trip) throws Exception
	{
		Thread.sleep(15000);
		...
		if(ModifySearch.equalsIgnoreCase("Yes"))
		{
			...
			if(ChangeTravellers.equalsIgnoreCase("Yes"))
			{
				...
				QaRobot.selectValueFromDropdown("v12AdultMF", adultM, "<b><i>Select Modified adult for booking</i></b>"+" - "+adultM);
				Thread.sleep(2000);

				QaRobot.selectValueFromDropdown("v12ChildMF", childM, "<b><i>Select Modified child for booking</i></b>"+" - "+childM);
				Thread.sleep(2000);

				QaRobot.selectValueFromDropdown("v12InfantMF", infantM, "<b><i>Select Modified infant for booking</i></b>"+" - "+infantM);
				Thread.sleep(2000);
			...
			if(AdvanceOptions.equalsIgnoreCase("Yes"))
			{
				...
				QaRobot.selectValueFromDropdown("CurrencyMF", CurrencyM, "<b><i>Select Modified Currency for booking</i></b>");
				Thread.sleep(2000);
				...
				for (int i = 1; i <= pAS; i++) 
				{
					...
					String b = tN[i-1];
					TestBase.listofautosuggestion1(By.xpath("//ul[@class='dropdown-menu-form  dropdown-menu']/li"),b,By.xpath("//input[@placeholder='Search']"));
				}
	...
	public static void ResultPageForHotel(String Rooms,String ModifySearch,String ChangeTripLocation,String CityCodeM,String CityTitleM,
			String ChangeTripDate,String CheckInDateM,String CheckOutDateM,String ChangeRooms,String RoomsM,String AdultM,String ChildM,
			String ChildAgeM,String ChangeCurrency,String CurrencyM,String ChangeStarRating,String StarRatingM) throws Exception
	{
		Thread.sleep(20000);
		...
		else
		{
			...
			else
			{
				...
				if(date3.before(date2))
				{
					...
					throw new B2cExceptionClass("Invalid Return Modified date provided "+Day1+"-"+Month1+"-"+Year1);
				}
				else
				{
