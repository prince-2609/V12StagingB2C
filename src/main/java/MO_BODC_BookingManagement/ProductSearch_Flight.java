...
public class ProductSearch_Flight {
	...
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("v12StagingBODC_Flight", "Sheet4");
	}

	@Test(dataProvider = "getexceldata")
	public static void BODCFlightSearch(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			String URL, String CompanyCode, String UserName, String Password, String ChooseSalesChannel, String Trip,
			...
			String SupNumber, String SelectSupplier, String ModifySearch, String ChangeTrip, String MarketTypeM,
			...
			String ChangeTravellers, String AdultM, String YouthM, String ChildM, String InfantM, String ChangeClass,
			String ClassM, String ShowDirectFlightM, String MyDatesAreFlexibleM, String AdvanceSearch,
			String SelectCurrency, String SelectNationality, String CountryOfResidence, String ChangeAirline,
			String PANumberM, String PreferredAirlineSelectM, String SupplierChange, String SupNumberM,
			String SelectSupplierM, String Applyfilter, String FareType, String Stops, String AirLine,
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultTitle, String AdultName,
			String AdultDate, String AdultEmailAddress, String PhoneNumber, String AdultPassportNumber,
			String AdultPassportcountry, String AdultExpiryDate, String AdultNationality, String YouthTitle,
			String YouthName, String YouthtDate, String YouthEmailAddress, String YouthPhoneNumber,
		...
		if (ChooseSalesChannel.equalsIgnoreCase("DirectCustomer")) {
			...
			BODCResultPage.ResultPageForFlight(Trip, TripType, ModifySearch, ChangeTrip, MarketTypeM, TripTypeM,
					OriginCityCodeM, OriginLocationM, DestinationCityCodeM, DestinationLocationM, ChangeTripDate,
					DepartureDateM, ReturnDateM, ChangeTravellers, AdultM, YouthM, ChildM, InfantM, ChangeClass, ClassM,
